...
//        Serial.println(ui_Right_Line_Tracker_Data);
        if (bt_3_S_Time_Up)
        {
         ...
         switch (stage){
          ...
          Serial.print("---");
          Serial.println(y);
          case 0: { //reverses until it sees all white
            Serial.println("case0");
            Drive(1400);
            if (ui_Left_Line_Tracker_Data < threshold && ui_Right_Line_Tracker_Data < threshold && ui_Middle_Line_Tracker_Data < threshold){
              stage=1; 
              x=1; //x is now equal to 1
            }
          }
          break;
          case 1:{ //turns until it tracks the line
          ...
          break;
          case 2:{ //tracks the line until it sees all white
          ...
          break;
          case 3: { //turns left until it tracks the line
          ...
          break;
          case 4: { //tracks line until it sees all black and reverses until it sees all white
            ...
            if (ui_Left_Line_Tracker_Data > threshold && ui_Right_Line_Tracker_Data > threshold && ui_Middle_Line_Tracker_Data > threshold)
            {
              x=2; // x is now equal to 2
              y=2; //y is now equal to 2
            }
            if (y == 2)
            {
              Drive(1400);
            ...
            {
              stage=5;
              y=3; // y is now equal to 3  
            }
          }
          
          break;
          case 5: { //turns 180 until it tracks the long line
